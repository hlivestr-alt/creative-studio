...
def enhance_prompt_with_completion(
    ...
    user_request = _build_user_request_compiled(
        ...
        (), creative_treatment_json, effective_shot_plan_json, cinematography_json, instrumental_style,
