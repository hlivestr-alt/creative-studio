...
DELIVERY_MARK_ALIASES = {
    ...
    "calm": "in a calm, steady voice, pitch level and the pace measured",
    "steady": "in a calm, steady voice, pitch level and the pace measured",
    "tranquilo": "in a calm, steady voice, pitch level and the pace measured",
    "tranquila": "in a calm, steady voice, pitch level and the pace measured",
    "sereno": "in a calm, steady voice, pitch level and the pace measured",
    "serena": "in a calm, steady voice, pitch level and the pace measured",
    "cold": "coldly", "frio": "coldly", "frío": "coldly",
    ...
    "temblando": "in a trembling, breath-thin voice, pitch wavering and words unevenly paced",
    "tembloroso": "in a trembling, breath-thin voice, pitch wavering and words unevenly paced",
    "temblorosa": "in a trembling, breath-thin voice, pitch wavering and words unevenly paced",
    "call out": "calls out, voice projected clear and bright, pitch carried forward at a brisk deliberate pace",
    "calls out": "calls out, voice projected clear and bright, pitch carried forward at a brisk deliberate pace",
    "calling out": "calls out, voice projected clear and bright, pitch carried forward at a brisk deliberate pace",
    "llamando": "calls out, voice projected clear and bright, pitch carried forward at a brisk deliberate pace",
...
DELIVERY_EMOJI = {
    ...
    "🗣": ("calls out, voice projected clear and bright, pitch carried forward at a brisk deliberate pace", "verb"),
    "🗣️": ("calls out, voice projected clear and bright, pitch carried forward at a brisk deliberate pace", "verb"),
    ...
    "😌": ("in a calm, steady voice, pitch level and the pace measured", "prose"),
    "😰": ("in a trembling, breath-thin voice, pitch wavering and words unevenly paced", "prose"),
    "⏸": ("__pause__", "pause"),
    "⏸️": ("__pause__", "pause"),
}
...
DELIVERY_FACE = {
    ...
    "🗣": "chin lifting, chest opening, mouth shaping the words broadly toward the distant listener",
    "🗣️": "chin lifting, chest opening, mouth shaping the words broadly toward the distant listener",
    ...
    "😌": "shoulders easing, gaze settling, breath lengthening as the face stays composed",
    "😰": "lower lip trembling, breath catching, eyes struggling to hold steady through the line",
}
